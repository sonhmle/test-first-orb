...
export KOB_APIKEY_INPUT=${!KOBITON_API_KEY}
APP_SUFFIX_INPUT="$(eval echo "$KOBITON_APP_TYPE")"
KOB_APP_ACCESS="$(eval echo "$KOBITON_APP_ACCESS")"

echo "APP_NAME_INPUT: ${APP_NAME_INPUT}"
echo "APP_PATH_INPUT: ${APP_PATH_INPUT}"
echo "APP_ID_INPUT: ${APP_ID_INPUT}"
echo "KOB_USERNAME_INPUT: ${KOB_USERNAME_INPUT}"
echo "KOB_APIKEY_INPUT: ${KOB_APIKEY_INPUT}"
echo "APP_SUFFIX_INPUT: ${APP_SUFFIX_INPUT}"
echo "KOB_APP_ACCESS: ${KOB_APP_ACCESS}"
